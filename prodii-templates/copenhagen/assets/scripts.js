jQuery(function ($) {
    $(".prd-ellipsis").ellipsis(
        {
            row     : 5,
            char    : "...",
            callback: function (text) {
                var _     = $(this),
                    _hide = _.next('.prd-hide'),
                    rm    = $('<br><a class="view-more" style="display: block ;" href="javascript:void(0)">Read more...</a>'),
                    rl    = $('<br><a class="view-less" style="display: block ;" href="javascript:void(0)">Read less...</a>');
...
// function getMapSimple(identity, lat, lng, zoom, pan_offset) {
    ...
    try {
        if (industriesdata) {
            ...
            for (var name in industriesdata) {
                ...
                if (industriescounter >= noofindustries) {
                    break;
                }
            }
        ...
        if (industriesdata) {
            ...
            if (restspace <= 0) {
                ...
                for (var name in industriesdata) {
                    ...
                    if (industrycounter > noofindustries - 1) {
                        break;
                    }
                }
                jQuery("#canvas_" + parentid).remove();
                ...
                var industrycolor = 0;
                for (var name in industriesdata) {
                    if (industrycolor > noofindustries - 1) {
                        break;
                    }
